...
int main(void) {
	...
	uint8_t example_POLY[30] =
			{ 0x22, 0x33, 0x44, 0x55, 0x24, 0x54, 0x00, 0x70 };

	uint8_t example_IMU[11] = { 0x22, 0x33, 0x44, 0x55, 0x22, 0x33, 0x55, 0x22,
			0x33, 0x44, 0x68 };

	uint8_t example_RAD[30] = { 0x22, 0x00, 0x44, 0x55, 0x52, 0x33, 0x55, 0x10, 0x11, 0x91, 0x00, 0x44, 0x55, 0x69, 0x15,
			0x22, 0x33, 0x44, 0x55, 0x22, 0x33, 0x55, 0x22, 0x11, 0x91, 0x01, 0x44, 0x55, 0xFF, 0x69 };
